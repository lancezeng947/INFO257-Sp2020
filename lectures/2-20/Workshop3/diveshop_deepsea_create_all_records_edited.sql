...
ALTER TABLE DIVECUST
 ADD Indirect_Sale CHAR(1);

INSERT INTO DIVECUST (Customer_No, Name, Street, City, State_Prov, Zip_Postal_Code, Country, First_Contact, Indirect_Sale)
 VALUES (10000, 'Bob Blushko', '123 West Elm', 'Berkeley', 'CA', '94704', 'U.S.A.', '2019-06-01', 'Y'),
        (10001, 'Jenny Burelly', '567 Vine St', 'Oakland', 'CA', '94611', 'U.S.A.', '2019-06-09', 'Y'),
        (10002, 'Steve Austin', '1188 Stone Cold Square', 'Miami', 'FL', '33101', 'U.S.A.', '2019-05-30', 'Y'),
        (10003, 'Paul Starr', '555 Ringo Ono Lane', 'Strawberry Fields', 'NY', '10001', 'U.S.A.', '2019-05-29', 'Y'),
